...
const NewsletterSignup = () => {
  return (
    <div className="bg-[#FAFAFA] text-black py-12 px-4 sm:px-8  font-inter flex flex-col md:flex-row items-center justify-center space-y-6 md:space-y-0 md:space-x-8">
      ...
      {/* Form Section */}
      <form className="flex items-center bg-cWhite space-x-4 md:w-1/2">
        <input
          type="email"
        ...
        <button
          type="submit"
          className="bg-gradient-to-r  from-cDarkBlue to-CPurple hover:opacity-75 text-cWhite font-medium py-2 px-6 rounded w-full h-full  transition duration-300 ease-in-out hover:bg-gray-100 hover:bg-gradient-to-r hover:from-cDarkBlue hover:to-CPurple "
        >
          Subscribe
        </button>
      </form>
