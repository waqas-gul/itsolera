...
const Vision = () => {
  return (
    <div className="flex flex-col-reverse font-inter md:flex-row items-center bg-white px-4 py-8 mx-20 sm:mx-2 md:px-8 md:py-12 gap-y-6">
      {/* Text Section */}
      ...
      <div className="flex-1 md:pr-8  sm:text-left md:text-left ">
